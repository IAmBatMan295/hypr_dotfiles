-- Black Metal colorscheme (default on startup)
return {
  {
    ...
    config = function()
      require("black-metal").setup({
        -----MAIN OPTIONS-----
        --
        -- Can be one of: bathory | burzum | dark-funeral | darkthrone | emperor |
        -- gorgoroth | immortal | impaled-nazarene | khold | marduk | mayhem | nile |
        -- taake | thyrfing | venom | windir
        theme = "immortal",
